				...
				<Row className="justify-content-md-center">
					<form>
						...
						<Row>
							...
							<select className="form-control" name="category" value={product.category} onChange={this.handleInputChange}>
								<option> </option>
								{categories.map(
						...
						<Row>
							...
							<input className="form-control" type="number" name="price" value={product.price} onChange={this.handleInputChange} />
						</Row>
						<Row>
